...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '专门为荒漠地区栽树研发的，土壤下直接供水植物根部的专利产品,en:Specifically developed for tree planting in desert areas and Supply water directly to the roots of plants under the soil.'

    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '润润泉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '润润泉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '润润泉, 产品', // 网站关键词 英文逗号隔开
